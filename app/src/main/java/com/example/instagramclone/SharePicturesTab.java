...
public class SharePicturesTab extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageView.setOnClickListener(SharePicturesTab.this);
        button.setOnClickListener(SharePicturesTab.this);
        ...
        switch(view.getId())
        {
            ...
            case R.id.button2:
            {
                if(recievedimageBitmap!=null)
                {
                    ...
                    {
                        FancyToast.makeText(getContext(),"You Must enter a description!!!",
                ...
                {
                FancyToast.makeText(getContext(),"You Must select a image!!!",
                            Toast.LENGTH_SHORT,FancyToast.ERROR,true).show();
    ...
    private void getChosenImage() {
        FancyToast.makeText(getContext(),"Now you can access the images",
                Toast.LENGTH_SHORT,FancyToast.SUCCESS,true).show();
        ...
        if(requestCode==2000)
        {
            if(resultCode== Activity.RESULT_OK)
            {
                try
                {
                    ...
                    cursor.close();
                    recievedimageBitmap= BitmapFactory.decodeFile(picPath);
